...
2. Update your values.yaml   
    ...
    Update your values.yaml with your container name ([see example of values.yaml here](https://github.com/pachyderm/pachyderm/blob/{{% majorMinorVersion %}}.x/etc/helm/examples/microsoft-values.yaml)) or use our minimal example below.
