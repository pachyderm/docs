...
{{% notice note %}}
See our [reference values.yaml](https://github.com/pachyderm/pachyderm/blob/{{% majorMinorVersion %}}.x/etc/helm/pachyderm/values.yaml#L827) for all available configurable fields of the proxy.
{{% /notice %}}
