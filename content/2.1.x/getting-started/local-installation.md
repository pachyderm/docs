...
- To install [JupyterHub and the Mount Extension](../../how-tos/jupyterlab-extension/#pachyderm-jupyterlab-mount-extension) on your local cluster,  run the following commands. You will be using our default [`jupyterhub-ext-values.yaml`](https://github.com/pachyderm/pachyderm/blob/{{< majorMinorVersion "minor">}}/etc/helm/examples/jupyterhub-ext-values.yaml):
  ...
  --values https://raw.githubusercontent.com/pachyderm/pachyderm/{{< majorMinorVersion "minor">}}/etc/helm/examples/jupyterhub-ext-values.yaml
  ```
