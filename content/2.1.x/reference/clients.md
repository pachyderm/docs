...
See the [OpenCV Example in Go](https://github.com/pachyderm/pachyderm/tree/{{< majorMinorVersion "minor">}}/examples/opencv) for more
information.
...
{{% notice note %}} 
Use **python-pachyderm v{{ config.python_pachyderm_version }}** with Pachyderm {{< majorMinorVersion "minor">}}. 
{{% /notice %}}
