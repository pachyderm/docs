...
!!! Note
    Note that this use case of the S3 Gateway differs from the [Global use case](_index.md). The latter runs directly on the `pachd` pod and exists independently and outside of any pipeline lifecycle. 
