...
You should use a `cross` input in a MLDM Pipeline Spec when you need to perform operations on combinations of data from multiple MLDM repositories. The `cross` input allows you to generate a set of combinations of files between two or more repositories, which can be used as the input to your pipeline.
